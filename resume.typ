...
#resume_desc(
  "项目简介",
  "在开源实时操作系统 NuttX RTOS 的基础上，借助已有的相关支持，为该系统的 SMP 对称多核适配实现了一个每核心维护本地序列的对称式二段调度器，并分别在模拟平台和实机平台上测试通过。"
)
#resume_desc(
  "承担工作",
...
#resume_desc(
  "专业技能竞赛",
  [2023 年 CCSC 全国大学生系统能力大赛操作系统设计赛功能挑战赛道全国总决赛二等奖，2022 年参与阿里云 Oceanbase 数据库挑战赛；]
)
#resume_desc(
  "数学建模竞赛",
